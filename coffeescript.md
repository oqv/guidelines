...
This guide is derived from [CoffeeScript Style Guide][coffeescript-guide] maintained by [mjrusso][mjrusso] and presents a collection of best-practices and coding conventions for the [CoffeeScript][coffeescript] programming language.
...
Use **spaces only**, with **2 spaces** per indentation level. Never use tabs.
